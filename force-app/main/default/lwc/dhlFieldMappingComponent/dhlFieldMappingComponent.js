...
export default class DhlFieldMappingComponent extends LightningElement {
  ...
  loadSalesforceObjects() {
    return getSalesforceObjectDiscovery({ connectorKey: "dhl" }).then(
      (result) => {
  ...
  get mappingOnlyWarning() {
    ...
    return "This pair is not registered yet. Saving valid field mappings will register it. Automated DHL processing remains limited to supported runtime objects.";
  }
