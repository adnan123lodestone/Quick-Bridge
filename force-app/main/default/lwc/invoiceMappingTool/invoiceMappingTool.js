...
const PAYPAL_INVOICE_REQUIRED_ROWS = [
    { sourceField: 'amount', targetField: 'Amount__c', sourceLabel: 'Amount' },
    { sourceField: 'referenceNumber', targetField: 'Reference_number__c', sourceLabel: 'Reference Number (Capture ID)' },
    { sourceField: 'status', targetField: 'Status__c', sourceLabel: 'Status' },
    { sourceField: 'invoiceDate', targetField: 'Invoice_Date__c', sourceLabel: 'Invoice Date' },
    { sourceField: 'paypalOrderId', targetField: '', sourceLabel: 'PayPal Order Id', isOptional: true },
    { sourceField: 'customerEmail', targetField: '', sourceLabel: 'Customer Email', isOptional: true },
    { sourceField: 'paymentQrCode', targetField: '', sourceLabel: 'Payment QR Code (HTML)', isOptional: true }
];
const PAYPAL_TRANSACTION_REQUIRED_ROWS = [
    ...
    { sourceField: 'gatewayTransactionId', targetField: 'Gateway_Transaction_Id__c', sourceLabel: 'Gateway Transaction Id' },
    { sourceField: 'paymentType', targetField: 'Payment_Type__c', sourceLabel: 'Payment Type' },
    { sourceField: 'paypalOrderId', targetField: 'PayPal_Order_Id__c', sourceLabel: 'PayPal Order Id', isOptional: true },
    { sourceField: 'paypalPayerId', targetField: 'PayPal_Payer_Id__c', sourceLabel: 'PayPal Payer Id', isOptional: true },
    { sourceField: 'paypalPayerEmail', targetField: 'PayPal_Payer_Email__c', sourceLabel: 'PayPal Payer Email', isOptional: true },
    { sourceField: 'paypalResourceId', targetField: 'PayPal_Resource_Id__c', sourceLabel: 'PayPal Resource Id', isOptional: true },
    { sourceField: 'paypalResourceStatus', targetField: 'PayPal_Resource_Status__c', sourceLabel: 'PayPal Resource Status', isOptional: true }
];
...
export default class InvoiceMappingTool extends LightningElement {
    ...
    async loadInitialState() {
        this.isLoading = true;
        try {
            const invoiceFieldsFetcher = (this.isAuthNet || this.isPayPal)
